...
AR = [0.279199278	0.373595506	0.467816554	0.555762269	0.649728042	0.738047307];
%AR = [0.483191169	0.573006628	0.683898815	0.770620108];
AR_ = AR/1e2;       % relative tolerated deviation from the target AR
K = 8;              % number of modeled bins
N_items = 10000;    % number of simulated bins per parameter setting
R_init = 10;         % initial value of step size constant C
