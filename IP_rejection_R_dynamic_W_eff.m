...
R_init = 1;         % initial value of step size constant C
...
for b = 1:L 
    ...
    while AR_temp < 0
        ...
        elseif ALGORITHM == 2
            IP = [zeros(1,B(b)),parameter.^series];                         % PRE
        end        
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        for h = 2:nsteps+1
            ...
            for pp = 1:2
                ...
                elseif ALGORITHM == 2
                    IP = [zeros(1,B(b)),parameter_.^series]; % PRE
                end               
    ...
    S_star = find(WG_bar_vector_temp==WG_bar_vector(b),1);
...
output2 = [WB_bar_vector; WR_bar_vector];
